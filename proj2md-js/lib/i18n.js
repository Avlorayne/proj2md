...
const LANG_TEXTS = {
  zh: {
    ...
    cli_epilog: [
      ...
      '',
      '反向还原（--restore）:',
      '  npx proj2md --restore bundle.md            # 把合集还原到当前目录',
      '  npx proj2md --restore bundle.md myproject  # 还原到指定目录',
      '  npx proj2md --restore bundle.md --dry-run  # 只预览动作，不写盘',
      '  npx proj2md --restore bundle.md --diff --backup          # 打印差异并备份旧文件',
      '  npx proj2md --restore reply.md --include-pattern "src/*" # 只还原 src 下文件',
      '  npx proj2md --restore --clip myproject     # 从剪贴板读取 AI 回复并写回',
      '  cat bundle.md | npx proj2md --restore - myproject        # 从标准输入读取',
      '',
      '说明:',
    ...
    list_item: '{i}. {path}  ({lang}, {n} 行){flag}',
    flag_trunc: '  [截断]',
  ...
  en: {
    ...
    cli_epilog: [
      ...
      '',
      'Restore (--restore):',
      '  npx proj2md --restore bundle.md             # restore a bundle into the current dir',
      '  npx proj2md --restore bundle.md myproject   # restore into a target dir',
      '  npx proj2md --restore bundle.md --dry-run   # preview actions, write nothing',
      '  npx proj2md --restore bundle.md --diff --backup           # show diffs and back up old files',
      '  npx proj2md --restore reply.md --include-pattern "src/*"  # restore only files under src/',
      '  npx proj2md --restore --clip myproject      # read the AI reply from the clipboard',
      '  cat bundle.md | npx proj2md --restore - myproject         # read from stdin',
      '',
      'Notes:',
    ...
    list_item: '{i}. {path}  ({lang}, {n} lines){flag}',
    ...
    info_clip_no_write: 'Tip: {path} was not created (--clip skips writing when the output file does not exist yet; pass -o to create it)',
...
let _CURRENT_LANG = detectSystemLang(); // ★ 修复（P0-2）：模块加载即按系统语言探测，
                                        //   --help / --restore 在 setLang 之前也能跟随系统
